...
import org.spiderdog.utils.CharsetUtils;
import org.spiderdog.utils.HttpClientUtils;
...
public class HttpClientDownloader extends AbstractDownloader {
    ...
    private CloseableHttpClient getHttpClient(SiteConfigBuilder siteConfigBuilder) {
        ...
        if (httpClient == null) {
            synchronized (this) {
                httpClient = httpClients.computeIfAbsent(domain, k -> httpClientGenerator.getClient(siteConfigBuilder));
            }
        }
        return httpClient;
    }
